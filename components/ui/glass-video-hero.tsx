  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center mt-32 px-6">
        ...
        <h1 className="text-foreground text-5xl lg:text-[96px] leading-[1.05] tracking-[-0.02em] mt-8 max-w-5xl font-bold">
          Book your perfect stay
          <br className="hidden lg:block" />
          instantly{" "}
          <em className="italic mx-[0.08em] relative inline-block">and</em>{" "}
          hassle-free
        </h1>

        <p className="text-lg text-muted-foreground mt-6 max-w-[662px]">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 mt-8">
          <button className="px-8 py-3.5 rounded-[10px] bg-primary text-primary-foreground font-medium text-base hover:brightness-110 transition-all shadow-lg shadow-primary/25">
            Book a Free Demo
          </button>
          <button className="px-8 py-3.5 rounded-[10px] bg-secondary text-secondary-foreground font-medium text-base hover:brightness-125 transition-all">
            Get Started Now
          </button>
        </div>
      </div>
