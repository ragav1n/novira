...
import { ArrowLeft, Plane, Plus, Calendar as CalendarIcon, MapPin, Edit2 } from 'lucide-react';
    ...
    const load = useCallback(async () => {
        ...
        try {
            ...
            if (error || !data || fetchGenRef.current !== myGen) {
                if (error) console.error('[TripsView] tx fetch error', error);
                return;
            }
            ...
            console.error('[TripsView] load failed', e);
        } finally {
    ...
    return (
        <div className="flex flex-col min-h-screen p-5 space-y-6 max-w-md mx-auto pb-32">
            <div className="flex items-center justify-between pt-2 gap-3">
                ...
                <Button size="icon" onClick={openCreate} aria-label="New trip" className="rounded-full w-10 h-10">
