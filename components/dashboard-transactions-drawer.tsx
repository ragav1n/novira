...
export const DashboardTransactionsDrawer = React.memo(function DashboardTransactionsDrawer({
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            <DialogContent showCloseButton={false} className="fixed inset-0 top-0 left-0 right-0 bottom-0 max-w-none w-full h-full bg-background border-none rounded-none p-0 overflow-hidden flex flex-col z-[110] translate-x-0 translate-y-0 shadow-none elevation-0">
