                ...
                <div className="relative flex-1">
                    ...
                    {search && (
                        <button
                            ...
                            className="absolute right-1 top-1/2 -translate-y-1/2 min-h-[40px] min-w-[40px] inline-flex items-center justify-center rounded-full text-muted-foreground hover:text-foreground hover:bg-secondary/40 transition-colors"
                        >
