    ...
    return (
        <div className="absolute top-0 left-0 right-0 z-20 flex flex-col sm:flex-row items-center justify-between p-4 sm:p-6 bg-gradient-to-b from-background/90 via-background/40 to-transparent pointer-events-none">
            <div className="w-full sm:w-auto flex items-center justify-between gap-3 pointer-events-auto">
                ...
                <button
                    onClick={onClose}
                    className="relative tap-target sm:hidden w-10 h-10 rounded-full bg-card/60 backdrop-blur-md flex items-center justify-center border border-white/10 hover:bg-white/10 transition-colors pointer-events-auto shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
            ...
            <button
                onClick={onClose}
                className="relative tap-target hidden sm:flex w-10 h-10 rounded-full bg-card/60 backdrop-blur-md items-center justify-center border border-white/10 hover:bg-white/10 transition-colors pointer-events-auto shrink-0"
                aria-label="Close map"
            >
                <X className="w-5 h-5" />
            </button>
