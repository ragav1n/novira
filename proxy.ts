...
export async function proxy(request: NextRequest) {
    const csp = [
        ...
        "font-src 'self'",
        "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.frankfurter.dev https://v6.exchangerate-api.com https://*.gstatic.com https://va.vercel-scripts.com https://*.mapbox.com https://maps.googleapis.com https://places.googleapis.com https://photon.komoot.io",
